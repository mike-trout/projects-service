...
<a href=""https://api.miketrout.dev/skills"">/skills</a> paths are routed to the backend
experience, projects and skills microservices. The repository for the API gateway is also on
<a href=""https://github.com/mike-trout/api.miketrout.dev"">GitHub</a> and also automatically
deployed by Travis CI.</p>

<p>The
<a href=""https://github.com/mike-trout/experience-service"">experience microservice</a>
is written in JavaScript and runs on Node.js. The
<a href=""https://github.com/mike-trout/projects-service"">projects microservice</a>
that returns this text is written in C# and uses the ASP.NET Core framework. The
<a href=""https://github.com/mike-trout/skills-service"">skills microservice</a>
